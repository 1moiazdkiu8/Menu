...
/**
 * Servlet implementation class MenusAllSearchRandomServlet
 */
@WebServlet("/menus/all/search/random")
public class MenusAllSearchRandomServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public MenusAllSearchRandomServlet() {
        super();
